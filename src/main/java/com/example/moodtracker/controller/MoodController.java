...
public class MoodController {
    ...
    @GetMapping
    public String getMoodsPage(@RequestParam(value = "q", required = false) String q,
    ...
    private Double averageRating(List<Mood> moods) {
        return moods.isEmpty() ? null : moods.stream().mapToInt(Mood::getMoodRating).average().orElseThrow();
    }
